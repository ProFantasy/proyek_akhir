...
<body>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="d-flex justify-content-between">
                      <p class="card-title">Jumlah Pembelian Berdasarkan Kurir</p>
                    </div>
                  ...
                  <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-tale">
                      <div class="card-body">
                        ...
                        <p class="fs-30 mb-2">{{ $jumlahcustomer }}</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-dark-blue">
                      <div class="card-body">
                        ...
                        <p class="fs-30 mb-2">{{ $jumlahpembelian }}</p>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  $(function() {
    if ($("#sales-chart").length) {
      var _ydata=JSON.parse('{!! json_encode($kurirs) !!}');
      var _xdata=JSON.parse('{!! json_encode($kurirCount) !!}');
