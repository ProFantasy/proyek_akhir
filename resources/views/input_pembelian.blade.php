            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="{{url('kirim_pembelian')}}">
                    @csrf
                    <div class="form-group">
                        ...
                        <select class="form-control @error('id_barang') is-invalid @enderror" id="position-option" name="id_barang">
                                @foreach ($barang as $item)
                                    <option value="{{ $item->kode_barang }}" {{ old('id_barang') == $item->kode_barang? 'selected' : null }}>{{ $item->nama_barang }}</option>
                                @endforeach
                        </select>
                                @error('kode_barang')
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('id_pembeli') is-invalid @enderror" id="position-option" name="id_pembeli">
                                @foreach ($customer as $items)
                                    <option value="{{ $items->ktp }}" {{ old('id_pembeli') == $items->ktp? 'selected' : null }}>{{ $items->nama }}</option>
                                @endforeach
                        </select>
                                @error('ktp')
                                    <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="jumlah" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror"  min="1" value="{{ old('jumlah') }}">
                        @error('jumlah')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <a class="btn btn-danger" href="{{ url('tampil_pembelian') }}">Batal</a>
                  </form>
                </div>
              </div>
            </div>
